-- ============================================================================
-- DRILLING MINIGAME (Scaleform-based)
-- ============================================================================

Scaleforms = {}

-- Load scaleform movie
...
-- Push multiple values to scaleform
...
Drilling.Type = 'VAULT_DRILL'  -- or 'VAULT_LASER'
...
Drilling.Init = function()
    ...
    local extra = Drilling.Type == 'VAULT_LASER' and "SET_LASER_WIDTH" or "SET_SPEED"
...
Drilling.HandleControls = function()
    ...
    -- Up/Down arrow controls for drill position
    ...
    -- Left/Right arrow controls for drill speed
    ...
    if Drilling.DrillTemp >= 1.0 then
        ...
        exports['sb_notify']:Notify('Drill overheated!', 'error', 3000)
    elseif Drilling.DrillPos >= 1.0 then
        Drilling.Result = true
        Drilling.Active = false
        Scaleforms.PopVoid(Drilling.Scaleform, "RESET")
        exports['sb_notify']:Notify('Drill successful!', 'success', 3000)
    end
